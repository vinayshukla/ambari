...
App.MainAdminClusterController = Em.Controller.extend({
  ...
  updateUpgradeVersionSuccessCallback: function (data) {
    ...
    var stackPrefix = App.get('currentStackName') + "-";
    var upgradeVersion = this.get('upgradeVersion')  || (App.get('isHadoopWindowsStack')? App.defaultWindowsStackVersion : App.defaultStackVersion );
    upgradeVersion = upgradeVersion.replace(stackPrefix, "");
    ...
    upgradeVersion = stackPrefix + upgradeVersion;
